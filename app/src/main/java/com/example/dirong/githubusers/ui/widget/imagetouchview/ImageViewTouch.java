...
public class ImageViewTouch extends ImageViewTouchBase {
    ...
    protected void onZoom(float scale) {
        super.onZoom(scale);
        if (LOG_ENABLED) {
            Log.d(LOG_TAG, "onZoom happened " + scale);
        }
    }
    ...
    protected void onZoomAnimationCompleted(float scale) {
        ...
        if (scale < getMinScale() && getMinScale() < getMaxScale()) {
    ...
    public void setOverlayImage(ImageView overlayImage) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (overlayImage != null && overlayImage.getHeight() != 0 && overlayImage.getWidth() != 0) {
            ...
            paint.setColor(Color.parseColor(getResources().getString(R.color.half_transparent_background)));
            canvas.drawRect(0, 0, getWidth(), overlayImage.getTop(), paint);
            canvas.drawRect(0, overlayImage.getTop(), overlayImage.getLeft(), overlayImage.getBottom(), paint);
            canvas.drawRect(0, overlayImage.getBottom(), getWidth(), getHeight(), paint);
            canvas.drawRect(overlayImage.getRight(), overlayImage.getTop(), getWidth(), overlayImage.getBottom(), paint);
